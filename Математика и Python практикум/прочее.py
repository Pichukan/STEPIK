...
def enigma(text,ref,rot1,shift1,rot2,shift2,rot3,shift3):
	...
	#print('before',text)
	otl=text
	text=rotor(text,tumbajumba[3],puksamuksa[0],way_flag)
	#print('after and before',text)
	#print('before',text)
	otl=otl+text
	text=rotor(text,tumbajumba[2],puksamuksa[1],way_flag)
	#print('after and before',text)	
	#print('before',text)
	otl=otl+text
	text=rotor(text,tumbajumba[1],puksamuksa[2],way_flag)
	#print('after',text)		
	#print('after and before reflector',text)
	otl=otl+text
	text=reflector(text,ref,puksamuksa[3])
	#print('after reflector',text)
	way_flag=True
	#print('after reflector and before',text)
	otl=otl+text
	text=rotor(text,tumbajumba[1],puksamuksa[4],way_flag)
	#print('reverse after',text)	
	#print('reverse after and before',text)
	otl=otl+text
	text=rotor(text,tumbajumba[2],puksamuksa[5],way_flag)
	#print('reverse after',text)	
	#print('reverse after and before',text)
	otl=otl+text
	text=rotor(text,tumbajumba[3],puksamuksa[6],way_flag)
	#print('reverse after',text)	
	otl=otl+text
	t=''
	#a=[]
