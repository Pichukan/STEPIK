...
def enigma(text,ref,rot1,shift1,rot2,shift2,rot3,shift3):
	...
	text_out=''	
	n=0	
	print(rotate_rotor(puksamuksa,tumbajumba,n,shift),'rotate rotor func',puksamuksa)
	'''
	'''
	for i in range(100):
		print(rotate_rotor(puksamuksa,tumbajumba,n,shift),'rotate rotor func')
	'''
	#--------------------------------------------------------------
	...
	for text_symbol in text:
		...
		shift=[0,5,6,10]
		puksamuksa=shift_rel(shift,len_tumba)
